      ...
      <Box sx={{ margin: "80px 100px" }}>
        <Box>
            ...
            <Box sx={{ position: "relative", marginBottom: "50px" }}>
              ...
              <Box sx={{ zIndex: 1, position: "absolute", top: "35%" }}>
                <Typography className={classes.textContentImg}>
                  Với tiêu chí đó mỗi sản phẩm của Nhà Hàng 5 Sao đều được qua
                  sàng lọc, chắt chiu, tinh khiết và quý báu nhất từ thiên
          ...
          <Typography className={classes.textContent}>
            Qua nhiều năm phát triển, Nhà Hàng 5 Sao đã dần dần khẳng định được
            vị thế của mình , đối với từng sản phẩm của Lẩu nấm Gia khánh, mỗi
            một món ăn là sự tinh túy chắt lọc qua thời gian từ những ngày đầu
            thành lập.
          </Typography>
          ...
          <Typography className={classes.textContent}>
            ...
            lẩu nấm tại Nhà Hàng 5 Sao. Giờ đây để Nhà Hàng 5 Sao đến gần hơn
            với cộng đồng thực khách, Nhà hàng chúng tôi không ngừng mở rộng
          ...
          <Typography className={classes.textContent}>
            Hãy để sản phẩm của Nhà Hàng 5 Sao đem đến sức khỏe, niềm vui và sự
            nhiệt tình trong từng bữa ăn cho thực khách.Chúng tôi cam kết luôn
            đồng hành cùng thực khách trong từng món ăn về giá trị dinh dưỡng,
            chất lượng và phong cách phục vụ. Với không gian kiến trúc mở, lấy
            thiên nhiên làm nền tảng, luôn thay đổi tạo cảm giác lạ và mới mẻ
            cho thực khách.
          </Typography>
        </Box>
      </Box>
